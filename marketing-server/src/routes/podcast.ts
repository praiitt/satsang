...
async function saveVideoLocally(
  ...
  try {
    ...
    const ALLOWED_DOMAINS = [
      ...
      'rraasi.com',
      'satsang-afbf9.firebasestorage.app',
      'rraasi-8a619.firebasestorage.app',
    ];

    // Check if domain ends with any of the allowed domains (to handle subdomains)
    ...
    return Promise.reject(new Error(`Invalid video URL: ${err.message}`));
  }
