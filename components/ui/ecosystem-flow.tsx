      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex-1 flex flex-col items-center text-center relative z-10">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Diagnostic Tools</h3>
            <p className="text-sm text-gray-400 max-w-[200px]">
              Astrology, Tarot & Numerology map your energetic state and identify hidden blocks.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex-1 flex flex-col items-center text-center relative z-10">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Satsang AI Guru</h3>
            <p className="text-sm text-gray-400 max-w-[220px]">
              Discuss your diagnosis with ancient wisdom to intellectually understand the remedy needed.
            </p>
          </motion.div>
