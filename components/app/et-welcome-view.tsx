  ...
  return (
    <div ref={ref} className="w-full pb-24 md:pb-32">
      ...
      <section className="mx-auto mt-12 max-w-4xl px-4 sm:mt-16">
        ...
        <div className="bg-background border-input group relative overflow-hidden rounded-2xl border shadow-lg transition-shadow hover:shadow-xl">
          <div className="relative aspect-video bg-gradient-to-br from-purple-900/20 to-blue-900/20">
            {/* Video Thumbnail/Preview */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <div className="mb-4 text-6xl">👽</div>
                <div className="mb-2 text-lg font-semibold">3I/ATLAS: Draco Mothership?</div>
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/20 transition-all group-hover:bg-black/30">
              <div className="bg-primary/90 text-primary-foreground flex h-20 w-20 items-center justify-center rounded-full shadow-lg transition-transform group-hover:scale-110">
                <svg
          ...
          <div className="p-6">
            ...
            <a
              href="https://www.gaia.com/share/video/incoming-3iatlas-draco-mothership?type=video&contentId=245534&rfd=SwwRYn&uuid=2e8376c7-8d11-4472-8eae-1d7d01b78f79&source=SHARE"
              target="_blank"
