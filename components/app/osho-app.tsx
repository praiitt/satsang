...
import { OshoWelcomeView } from '@/components/app/osho-welcome-view';
...
const MotionOshoWelcomeView = motion.create(OshoWelcomeView);
...
interface OshoAppProps {
  appConfig: AppConfig;
}

export function OshoApp({ appConfig }: OshoAppProps) {
  return (
