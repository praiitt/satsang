export const en = {
  ...
  rraasHome: {
    ...
    heroHeadline1: 'Healing Music,',
    heroHeadline2: 'Made for Your Soul',
    heroSubtitle: 'Create personalised bhajans, trance, healing frequencies & meditation music with AI — then explore satsang, astrology and tarot on your journey inward.',
    ...
    musicSpotlightBadge: '✦ Featured',
    musicSpotlightTitle: 'RRAASI Music',
    musicSpotlightHindSub: 'आपकी आत्मा के लिए संगीत',
    musicSpotlightDesc: "The world's first AI that creates personalized spiritual music — bhajans, mantras, trance & healing frequencies — tuned to your soul.",
