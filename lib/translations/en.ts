export const en = {
  ...
  welcome: {
    title: 'RRAASI — Experience Your Spiritual Dimension',
    subtitle: 'AI-Guided Practices That Reveal the Divine Intelligence Within You',
    description:
      'Satsang means "being with truth"—an intellectual way of connecting with yourself. Truth reveals itself differently to different people, which is why humanity has countless spiritual masters. RRAASI gives you access to all these voices, helping you find the one that resonates with your soul. Voice-powered wisdom in Hindi and English.',
    vision: 'One Platform, Many Masters, One Truth',
    visionDesc:
      'Each master offers a unique path to the same truth. Through focused dialogue, you discover deeper insights about existence and your spiritual dimension.',
  ...
  rraasHome: {
    title: 'RRAASI',
    tagline: 'Experience Your Spiritual Dimension',
    subtitle: 'AI-guided practices that reveal the divine intelligence within you',
    description:
      'We believe giving focus and time to anything reveals itself—and this rule applies to the spirit dimension as well. All our services bring you closer to your spiritual dimension through focused attention.',
    ...
    satsangDesc: 'Satsang means "being with truth"—an intellectual way of connecting with yourself by giving time to what points toward spirituality. Truth reveals itself differently to different people, which is why humanity has been blessed with countless spiritual masters. Each master offers a unique way of pointing to the same truth. RRAASI gives you the opportunity to discover and connect with all these masters, even ones you may not know yet, so you can find the voice that resonates with your soul.',
    satsangFeature1: 'Connect with 50+ Global Spiritual Masters',
    satsangFeature2: 'Voice-Enabled Conversations (Hindi & English)',
    satsangFeature3: 'Wisdom from All Faiths & Traditions',
    satsangFeature4: 'Clarity through intellectual exploration',
    satsangAction: 'Start Satsang Now',

    // Astrology Section
    astrologyTitle: 'Vedic Astrology',
    astrologySubtitle: 'Understanding the Divine Plan',
    astrologyDesc: 'Vedic Astrology reveals the cosmic intelligence woven into your life\'s blueprint. By focusing on your birth chart and planetary movements, you discover how higher intelligence orchestrates your spiritual journey. This ancient science shows you\'re part of a divine plan.',
    ...
    astrologyFeature4: 'Trust in cosmic order',
    astrologyAction: 'Get Early Access',

    // Music Section
    musicTitle: 'RRAASI Music Creator',
    musicSubtitle: 'The Path of Presence',
    musicDesc: 'Music is a powerful way of being in the moment. Through AI-generated spiritual music tailored to your journey, you give focused attention to your spirit dimension. Each composition is designed to ground you in presence, where the spiritual reveals itself naturally.',
    ...
    musicFeature4: 'Experience through presence',
    musicAction: 'Create Music',

    // Tarot Section
    tarotTitle: 'Mystic Tarot Reading',
    tarotSubtitle: 'Messages from Higher Dimensions',
    tarotDesc: 'Tarot readings help you receive guidance from higher dimensions. Through focused attention on sacred symbols and archetypes, you create space for messages from your higher self and spiritual guides. AI helps interpret these divine communications for your unique journey.',
    ...
    aboutDesc1:
      'Focus + Time = Revelation. We believe giving focus and time to anything reveals itself — and this rule applies to the spirit dimension as well.',
    aboutDesc2:
      'RRAASI uses AI to guide your attention through practices that connect you with your spiritual dimension. Every service is designed to help you experience the divine intelligence within.',
    aboutQuote:
      'Give your attention to the spiritual dimension, and it will reveal itself to you.',
    comingSoonTitle: 'More Paths to Spirit',
    ...
    ctaTitle: 'Begin Your Spiritual Discovery',
    ...
    // Music Hero & Spotlight Section (new)
    heroLiveBadge: 'Your AI Spiritual Sanctuary',
    heroHeadline1: 'A Spiritual Sanctuary',
    heroHeadline2: 'All Your Tools in One Place',
    heroSubtitle: 'Whether you are taking your first step or deepening your practice, RRAASI empowers you with 60+ AI Masters, ET Wisdom, Astrology, Tarot, and the Spiritual Studio—all interconnected on one platform.',
    heroProblemStatement: 'As stress and anxiety rise globally, the need for deep, authentic healing has never been greater. Yet, spiritual seekers lack a unified platform that brings together diagnosis, processing, and healing. RRAASI bridges this gap by interconnecting ancient diagnostic tools with AI-driven sound healing and master guidance, helping you overcome mental blocks and restore profound balance to your life.',
    heroCta1: 'Create Your Music',
    heroCta2: 'Listen Free',
    heroStat1: '1000+ Tracks Created',
    heroStat2: '50+ Languages',
    heroStat3: 'Daily New Creations',

    musicSpotlightBadge: '✦ AI Creative Hub',
    musicSpotlightTitle: 'Spiritual Studio',
    musicSpotlightHindSub: 'Create Music, Art, and Reels for Your Soul',
    musicSpotlightDesc: "The world's first AI hub that generates personalized spiritual remedies — from 432Hz healing tracks to sacred art and videos — tuned perfectly to your energetic diagnosis.",
    musicSpotlightStat1N: '1000+', musicSpotlightStat1L: 'Spiritual Tracks',
    musicSpotlightStat2N: 'Daily',  musicSpotlightStat2L: 'New Creations',
    musicSpotlightStat3N: 'YouTube', musicSpotlightStat3L: 'Ready to Publish',
    musicSpotlightStat4N: 'AI',     musicSpotlightStat4L: 'Music Videos',

    musicCreateTitle: 'Create in Seconds',
    musicCreateDesc: 'Tell our AI what you feel — devotional, meditative, healing — and it crafts a sacred track just for you in under 2 minutes.',
    musicFeatureBhajan: '🎼 Bhajans, Mantras & Healing Frequencies',
    musicFeatureTrance: '🌀 Trance & Psychedelic Spiritual Music',
    musicFeatureVocals: '🗣️ Vocals or Purely Instrumental',
    musicFeatureLang:   '🌐 Hindi, Sanskrit, English & 50+ Languages',
    musicFeatureYT:     '🎬 AI Music Videos — publish to YouTube',
    musicCtaStart: 'Start Creating — Free',

    musicTile1Title: 'AI Composer',
    musicTile1Desc:  'Voice-guided creation — just describe what you feel',
    musicTile2Title: 'Trance Music',
    musicTile2Desc:  'Psychedelic trance & shamanic soundscapes for the soul',
    musicTile3Title: 'YouTube Ready',
    musicTile3Desc:  'Publish music & videos straight to your channel',
    musicTile4Title: 'AI Music Video',
    musicTile4Desc:  'Auto-generate a visual music video for every track',

    latestCreationsTitle: 'Latest Community Creations',
    latestCreationsSub: 'New spiritual tracks added daily by our community',
    latestCreationsSeeAll: 'See all 1000+ →',
    latestCreationsPlay: 'Play',
  ...
  profile: {
    ...
    rraasCoins: 'RRAASI Coins',
    viewCoinDetails: 'View Coin Details',
    ...
    referralDesc: 'Share your unique referral code with friends and earn bonus coins!',
    copy: 'Copy',
    copied: 'Copied!',
