export const musicTranslationsEn = {
    ...
    browse: {
        ...
        subtitle: 'Explore healing music created by our community',
        searchPlaceholder: 'Search music...',
        noResults: 'No music found',
        createFirst: 'Be the first to create music in this category!',
        loading: 'Loading music...',
        loginRequired: 'Please login to see your music',
