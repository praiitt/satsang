export const hi = {
  ...
  psychedelicGuru: {
    ...
    description:
      'ट्रेन्स म्यूजिक (Trance Music) का उपयोग करके ध्यान की एक गतिशील विधि। संगीत के माध्यम से उच्च लोकों (Higher Realms) को खोलें और अहंकार को विलीन करें।',
  ...
  gurus: {
    ...
    psychedelicGuru: {
      ...
      description:
        'ट्रेन्स म्यूजिक (Trance Music) और गतिशील ध्यान के माध्यम से उच्च लोकों का मार्गदर्शक। संगीत ही विधि है।',
    },
    tarot: {
