...
export function useTranslation(language: Language) {
  return (key: string) => getTranslation(language, key);
    ...
    music: {
      ...
      featuresTitle: 'What You Can Create',
      bhajansTitle: 'Devotional Bhajans',
      bhajansDesc: 'Create beautiful bhajans for Krishna, Shiva, Ram, and other deities',
      healingTitle: 'Healing Frequencies',
      healingDesc: '432Hz, 528Hz, and other Solfeggio frequencies for healing',
      meditationTitle: 'Meditation Music',
      meditationDesc: 'Ambient soundscapes for deep meditation',
      mantrasTitle: 'Sacred Mantras',
      mantrasDesc: 'Om, Gayatri Mantra, and other Vedic mantras',
      yogaTitle: 'Yoga Music',
      yogaDesc: 'Music for yoga practice and relaxation',
      customTitle: 'Custom Creations',
      customDesc: 'Describe any spiritual music you need',
      howItWorksTitle: 'How It Works',
      step1Title: 'Tell the AI what you need',
      step1Desc: 'Describe the music you want',
      step2Title: 'AI generates your music',
      step2Desc: 'AI creates music in seconds',
      step3Title: 'Listen and refine',
      step3Desc: 'Request changes until perfect',
      step4Title: 'Download and share',
      step4Desc: 'Use it for meditation or yoga',
      ctaText: 'Ready to create your spiritual soundtrack?',
      ctaButton: 'Get Started Free',
    },
