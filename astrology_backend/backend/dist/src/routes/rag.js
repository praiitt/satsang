...
router.post('/store-user-profile', async (req, res) => {
  try {
    ...
    const result = await ragService.storeUserChartData(userId, profileData);
...
router.post('/store-chart-data', async (req, res) => {
  try {
    ...
    const result = await ragService.storeUserChartData(userId, {
      ...chartData.data,
      userId,
      type: chartData.type
    });
...
router.post('/get-chart-for-query', async (req, res) => {
  try {
    ...
    const ragResult = await ragService.retrieveRelevantCharts(userId, query);
...
router.get('/user-charts/:userId', async (req, res) => {
  try {
    ...
    const result = await ragService.getAllUserCharts(userId);
...
router.delete('/user-charts/:userId', async (req, res) => {
  try {
    ...
    const result = await ragService.deleteUserCharts(userId);
...
router.get('/user-charts/:userId/exists', async (req, res) => {
  try {
    ...
    const hasCharts = ragService.hasUserCharts(userId);
